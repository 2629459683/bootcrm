        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" method="get"
                      action="${pageContext.request.contextPath }/toCustomer.action">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="col-md-12 text-right">
                        <dnsoft:page url="${pageContext.request.contextPath}/toCustomer.action"/>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
...
<script type="text/javascript">
    ...
    function createCustomer(){
        $.post(
            "<%=basePath%>customer/create.action",
    ...
    function editCustomer(id){
        ...
        $.ajax({
            type:"get",
            url:"<%=basePath%>getCustomerById.action",
            data:{"id":id},
    ...
    function updateCustomer(){
        var updateData = $("#edit_customer_form").serialize();

        $.post("<%=basePath%>update.action",updateData,function (data) {
            if(data=="OK"){
                alert("客户信息修改成功！");
                window.location.reload();
            }else{
